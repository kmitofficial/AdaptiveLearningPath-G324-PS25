/**
 * https://alp-project-final-main.onrender.com
 ...
 * https://dashboard.render.com/web/srv-d0rjhlje5dus73810gh0/deploys/dep-d0rjhlre5dus73810gpg?r=2025-05-28%4016%3A23%3A56%7E2025-05-28%4016%3A26%3A53
 */
...
app.use(cors({
  origin: ['http://localhost:3000', 'https://alp-therapist-main.onrender.com', 'https://alp-project-final-main.onrender.com'],
...
app.post('/api/auth/:role/signup', async (req, res) => {
  try {
    ...
    // Check for existing email (email must be unique across all roles)
    ...
    if (existingUsername) {
      return res.status(400).json({ message: 'Username already taken in this role' });
    }
...
app.post('/api/auth/forgot-password', async (req, res) => {
  try {
    ...
    const resetLink = `https://alp-project-final-main.onrender.com/reset-password/${resetToken}`;
